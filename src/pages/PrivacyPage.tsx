...
export const PrivacyPage: React.FC<PrivacyPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-[#C1121F] selection:text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-b from-[#C1121F]/15 via-blue-900/10 to-transparent blur-3xl pointer-events-none" />
      ...
      <main className="flex-1 pt-28 pb-20 relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="p-6 sm:p-10 rounded-3xl bg-gradient-to-br from-[#0F172A] via-[#0A0E1A] to-[#050505] border border-slate-700/80 shadow-2xl space-y-6 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-80 h-80 bg-[#C1121F]/10 blur-3xl rounded-full pointer-events-none" />
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
              <div className="space-y-3 max-w-2xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#C1121F]/20 border border-[#C1121F]/40 text-[#FF2A36] text-xs font-bold font-mono">
                  <ShieldCheck size={14} />
                  <span>Official Legal Document • NeCast Live</span>
                </div>
                <h1 className="text-2xl sm:text-4xl font-black text-white tracking-tight leading-tight">
                  Privacy Policy & Data Security
                </h1>
                <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
                  Comprehensive disclosures on Google OAuth 2.0 authentication, YouTube Data API compliance, Android runtime permissions, zero-password policy, and hardware KeyStore encryption.
                </p>
              </div>
            ...
            {/* Compliance Stats Highlights */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 relative z-10 text-xs">
              <div className="p-3 rounded-xl bg-black/40 border border-white/10">
                <div className="text-slate-400 text-[11px]">Effective Date</div>
                <div className="text-white font-bold font-mono">July 26, 2026</div>
              </div>
              <div className="p-3 rounded-xl bg-black/40 border border-white/10">
                <div className="text-slate-400 text-[11px]">Version</div>
                <div className="text-white font-bold font-mono">v1.0.4</div>
              </div>
              <div className="p-3 rounded-xl bg-black/40 border border-white/10">
                <div className="text-slate-400 text-[11px]">Google User Data</div>
                <div className="text-emerald-400 font-bold">Limited Use Compliant</div>
              </div>
              <div className="p-3 rounded-xl bg-black/40 border border-white/10">
                <div className="text-slate-400 text-[11px]">Password Storage</div>
                <div className="text-[#FF2A36] font-bold">Zero Exposure</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-[#0A0A0A] border border-white/10 flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              <a href="#google-api" className="px-3 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-colors">
                Google & YouTube API
              </a>
              <a href="#data-collected" className="px-3 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-colors">
                Collected Data
              </a>
              <a href="#permissions" className="px-3 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-colors">
                Android Permissions
              </a>
              <a href="#security" className="px-3 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-colors">
                KeyStore Security
              </a>
              <a href="#data-deletion" className="px-3 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 transition-colors">
                Account & Data Deletion
              </a>
            </div>
          </div>

          {/* Privacy Document Main Body Container */}
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-[#0F172A] to-[#0A0A0A] border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="space-y-1 text-center sm:text-left">
              <h3 className="text-base sm:text-lg font-bold text-white">Have questions about your data or Google OAuth?</h3>
              <p className="text-xs text-slate-400">Our security team responds to privacy inquiries within 48 hours.</p>
            </div>
            <div className="flex items-center gap-3 shrink-0">
              <a
                href="mailto:support@necast.live?subject=Privacy%20Data%20Query"
